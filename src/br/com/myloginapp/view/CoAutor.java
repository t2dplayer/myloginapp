 ...
 * @author sergi
 */
public class CoAutor extends javax.swing.JFrame {

    /**
     * Creates new form CoAutor
     */
    public CoAutor() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CoAutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
